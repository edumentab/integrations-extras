...
FDB_TLS_PORT=4500:tls

# --listen_address 127.0.0.1:$FDB_TLS_PORT:tls --public_address $PUBLIC_IP:4500:tls \
fdbserver --listen_address 0.0.0.0:$FDB_TLS_PORT --public_address $PUBLIC_IP:$FDB_TLS_PORT \
